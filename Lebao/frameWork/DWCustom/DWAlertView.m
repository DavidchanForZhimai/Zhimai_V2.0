...
static const float backgroundViewAlpha = 0.2;
...
// blocks
@property (nonatomic, copy) DWAlertViewBlock buttonBlock;
@property (nonatomic, copy) DWAlertViewBlock dismissBlock;
...
+ (instancetype)alertViewWithTitle:(NSString *)title
               ...
               buttonTouchedAction:(DWAlertViewBlock)buttonAction
                     dismissAction:(DWAlertViewBlock)dismissAction {
    return [[DWAlertView alloc] initWithTitle:title message:message buttonTitle:buttonTitle buttonTouchedAction:buttonAction dismissAction:dismissAction];
}
