...
//新增代码块
@class FSComboListView;
typedef void (^ComboboxOpenedOrCloseBlock) (FSComboListView *comboListView,BOOL isOpen);
typedef void (^ComboboxChangedBlock) (FSComboListView *comboListView,NSString* toValue);
...
@property (nonatomic, copy) ComboboxOpenedOrCloseBlock isOpenBlock;
@property (nonatomic, copy) ComboboxChangedBlock changedBlock;
