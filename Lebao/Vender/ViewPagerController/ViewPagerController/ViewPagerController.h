 ...
 * ViewPagerOptionStartFromThisTab: 1.0: YES, 0.0: NO, defines if view should appear with the 1st or 2nd tab. Defaults to NO
...
typedef NS_ENUM(NSUInteger, ViewPagerOption) {
    ...
    ViewPagerOptionStartFromThisTab,
...
/**
 *  should or no UIViewPageControl
 */

@property(nonatomic,assign)BOOL ispageViewController;
