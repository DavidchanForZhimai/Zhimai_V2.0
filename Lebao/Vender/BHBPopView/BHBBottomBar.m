...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [back bhb_setImageWithResourcePath:@"tabbar_compose_below_background" AutoSize:NO];
        ...
        [btn bhb_setImage:@"tabbar_compose_background_icon_add"];
        ...
        [backbtn bhb_setImage:@"tabbar_compose_background_icon_return"];
        [backbtn bhb_setBGImage:@"tabbar_compose_left_button"];
        ...
        [secCloseBtn bhb_setImage:@"tabbar_compose_background_icon_close"];
        [secCloseBtn bhb_setBGImage:@"tabbar_compose_right_button"];
