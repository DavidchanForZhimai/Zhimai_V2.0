...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text=self.dataSource[indexPath.row][@"area"];
    return cell;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.delegate respondsToSelector:@selector(resultViewController:didSelectFollowCity: cityID:)]) {
        [self.delegate resultViewController:self didSelectFollowCity:self.dataSource[indexPath.row][@"area"] cityID:self.dataSource[indexPath.row][@"id"] ];
    }
}
